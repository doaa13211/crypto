      ...
      <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-300 max-w-2xl mx-auto">Encrypt your message using the RSA algorithm.</p>
          </div>
          ...
          {!keys && (
            ...
            >
              <p className="text-slate-300 mb-4">First, you need to generate RSA keys.</p>
              <Link href="/make-key">
                <motion.button
          ...
          <div className="mb-6">
            <details className="neon-border rounded-lg p-4">
              <summary className="cursor-pointer text-blue-400 font-semibold">Paste Keys (Optional)</summary>
